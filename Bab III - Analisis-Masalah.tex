...
\begin{table}[H]
  ...
  \begin{tabular}{p{1.2cm}p{9cm}p{2.2cm}}
    ...
    FR-03 & Prototipe harus mampu menjalankan \textit{payload} secara \textit{fileless}. & CTQ-03\\
...
\begin{table}[H]
  \centering
  \caption{Kebutuhan nonfungsional (Non-Functional Requirements)\label{tab:NonFunctional-requirement-table}}
...
\begin{table}[H]
  \centering
  \caption{Alternatif Solusi\label{tab:Alternatif-solution-table}}
