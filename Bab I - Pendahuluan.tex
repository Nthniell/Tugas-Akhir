...
\begin{enumerate}
    ...
    \item mengembangkan modul \textit{Packer Spyware Mode Stealth} dengan \textit{lightweight payload} untuk \textit{Initial Access}.
    \item Melakukan pengujian komparatif prototipe \textit{packer spyware mode stealth} pada sejumlah produk \textit{anti-spyware} dan EDR komersial untuk mengevaluasi tingkat keberhasilan dan kegagalan deteksi.
...
\begin{enumerate}
    ...
    \item Aktivitas \textit{malware} yang diujikan dibatasi secara ketat pada tahap penyusupan, enkripsi \textit{payload} dan \textit{fileless execution}.
